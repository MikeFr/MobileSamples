...
public class GcmIntentService extends IntentService {
    ...
    // a GCM message.
    private void sendNotification(String msgTypeMessage, Bundle extras) 
    {
    	String responce =  extras.toString();
    	String message = msgTypeMessage + extras.getString("message");
    	
        mNotificationManager = (NotificationManager)
                this.getSystemService(Context.NOTIFICATION_SERVICE);

        Intent dispIntent = new Intent(this, DisplayActivity.class); 
        dispIntent.putExtra("message", message);
        ...
        stackBuilder.addNextIntent(dispIntent);
